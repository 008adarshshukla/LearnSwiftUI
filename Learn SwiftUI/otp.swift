...
//  Learn SwiftUI
//
//  Created by Adarsh Shukla on 07/12/22.
//
...
struct OtpView_SwiftUI_Previews: PreviewProvider {
    static var previews: some View {
        OtpView_SwiftUI(otpCode: .constant("2373"), otpCodeLength: 4, textColor: .black, textSize: 15)
    }
}
